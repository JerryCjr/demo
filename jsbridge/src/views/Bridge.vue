<template>
  <div class="root">
    ...
    <div class="app" v-if="isApp">
      <p class="share-app-message" @click="nativeShareMenu">
        唤起原生的分享菜单
      </p>
      <p class="share-app-message" @click="shareAppMessage">
        唤起原生的分享好友
      </p>
      <p class="share-timeline" @click="shareTimeline">唤起原生的分享朋友圈</p>
      <p class="share-timeline" @click="nativeShareMenuToShareImage">
        唤起原生的分享菜单(分享图片)
      </p>
    </div>
  </div>
